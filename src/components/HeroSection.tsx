      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-8 max-w-7xl mx-auto w-full z-10 mt-6 lg:mt-0">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <FadeIn delay={0.1} y={20}>
            <div className="mb-6 inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-slate-200 dark:border-white/10 bg-white/50 dark:bg-white/5 backdrop-blur-md shadow-sm">
          ...
          <FadeIn delay={0.2} y={30}>
            <h1 className="hero-heading font-black uppercase tracking-tight leading-[1.05] text-[clamp(3rem,8vw,6.5rem)] mb-6 drop-shadow-[0_10px_20px_rgba(182,0,168,0.15)] dark:drop-shadow-[0_0_30px_rgba(182,0,168,0.3)] hover:drop-shadow-[0_15px_40px_rgba(182,0,168,0.3)] dark:hover:drop-shadow-[0_0_50px_rgba(182,0,168,0.8)] transition-all duration-500">
          ...
          <FadeIn delay={0.4} y={20}>
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4 sm:gap-6">
              ...
              <a href="https://www.linkedin.com/in/swastiksinha1" target="_blank" rel="noreferrer" className="group">
                <div className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-full border-2 border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 group-hover:border-[#7621B0] dark:group-hover:border-[#7621B0] group-hover:shadow-[0_0_20px_rgba(118,33,176,0.3)] transition-all duration-300 hover:scale-110">
        ...
        <div className="flex-1 flex justify-center lg:justify-end w-full">
          <FadeIn delay={0.5} y={30}>
            <div className="relative group cursor-pointer mt-10 lg:mt-0">
              
              {/* Refined, Tighter Background Glow without expensive CSS Blur */}
              <div className="absolute inset-[-20%] bg-[radial-gradient(circle_at_center,_rgba(182,0,168,0.25)_0%,_rgba(118,33,176,0.1)_50%,_transparent_70%)] rounded-full opacity-100 group-hover:opacity-100 transition-opacity duration-700"></div>
              
              {/* Main Avatar Container */}
              <div className="relative w-[280px] h-[280px] sm:w-[340px] sm:h-[340px] lg:w-[380px] lg:h-[380px] rounded-full overflow-hidden border-[4px] border-white dark:border-[#1A1A1A] shadow-[0_10px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_15px_40px_rgba(0,0,0,0.4)] group-hover:shadow-[0_0_40px_rgba(182,0,168,0.3)] transition-all duration-500 group-hover:scale-105 group-hover:rotate-2">
                <img 
                  src="https://media.licdn.com/dms/image/v2/D5603AQE6dlbDW_eFtA/profile-displayphoto-shrink_400_400/B56ZX807PQGsAg-/0/1743703488612?e=1781136000&v=beta&t=drWoQbeaNhYAgLwjfFkJaHEZz3Z48_XdCSqpfRWcB6c" 
                  alt="Swastik Sinha" 
